...
func init() {
	...
	// groupDescIsMemberGroup is the schema descriptor for is_member_group field.
	groupDescIsMemberGroup := groupFields[8].Descriptor()
	// group.DefaultIsMemberGroup holds the default value on creation for the is_member_group field.
	group.DefaultIsMemberGroup = groupDescIsMemberGroup.Default.(bool)
