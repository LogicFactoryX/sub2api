...
func init() {
	...
	// groupDescShowToAllUsers is the schema descriptor for show_to_all_users field.
	groupDescShowToAllUsers := groupFields[8].Descriptor()
	// group.DefaultShowToAllUsers holds the default value on creation for the show_to_all_users field.
	group.DefaultShowToAllUsers = groupDescShowToAllUsers.Default.(bool)
	...
	usergroupentitlementFields := schema.UserGroupEntitlement{}.Fields()
	_ = usergroupentitlementFields
	// usergroupentitlementDescStartsAt is the schema descriptor for starts_at field.
	usergroupentitlementDescStartsAt := usergroupentitlementFields[4].Descriptor()
	// usergroupentitlement.DefaultStartsAt holds the default value on creation for the starts_at field.
	usergroupentitlement.DefaultStartsAt = usergroupentitlementDescStartsAt.Default.(func() time.Time)
	// usergroupentitlementDescStatus is the schema descriptor for status field.
	usergroupentitlementDescStatus := usergroupentitlementFields[6].Descriptor()
	// usergroupentitlement.DefaultStatus holds the default value on creation for the status field.
	usergroupentitlement.DefaultStatus = usergroupentitlementDescStatus.Default.(string)
	// usergroupentitlement.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	usergroupentitlement.StatusValidator = usergroupentitlementDescStatus.Validators[0].(func(string) error)
	// usergroupentitlementDescCreatedAt is the schema descriptor for created_at field.
	usergroupentitlementDescCreatedAt := usergroupentitlementFields[8].Descriptor()
	// usergroupentitlement.DefaultCreatedAt holds the default value on creation for the created_at field.
	usergroupentitlement.DefaultCreatedAt = usergroupentitlementDescCreatedAt.Default.(func() time.Time)
	// usergroupentitlementDescUpdatedAt is the schema descriptor for updated_at field.
	usergroupentitlementDescUpdatedAt := usergroupentitlementFields[9].Descriptor()
	// usergroupentitlement.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	usergroupentitlement.DefaultUpdatedAt = usergroupentitlementDescUpdatedAt.Default.(func() time.Time)
	// usergroupentitlement.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	usergroupentitlement.UpdateDefaultUpdatedAt = usergroupentitlementDescUpdatedAt.UpdateDefault.(func() time.Time)
