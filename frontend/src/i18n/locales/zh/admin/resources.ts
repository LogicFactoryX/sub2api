export default {
    ...
    redeem: {
      ...
      groupCardTarget: '授权分组',
      groupCardTargetPlaceholder: '选择兑换后获得的分组',
      fallbackGroup: '到期后分组',
      fallbackGroupPlaceholder: '选择 API Key 到期后迁移的分组',
      fallbackGroupHint: '权益到期后，仍使用授权分组的 API Key 将自动迁移到此分组。',
      fallbackGroupRequired: '请选择到期后迁移分组',
      days: '天',
      status: {
        unused: '未使用',
        used: '已使用',
