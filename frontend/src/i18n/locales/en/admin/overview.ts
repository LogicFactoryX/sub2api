export default {
    ...
    users: {
      ...
      memberGroups: 'Member Groups (Available to Members)',
    ...
    groups: {
      ...
      memberGroupHint: 'Visible to everyone, but only active members can select and use it.',
      memberFallbackGroup: 'Membership expiry fallback',
      memberFallbackRequired: 'Select a public fallback group for membership expiry.',
